...
public static class Debug 
{
    ...
    {
        UnityEngine.Debug.LogFormat((string)message, args);
    }

    [System.Diagnostics.Conditional("UNITY_EDITOR")]
    public static void LogErrorFormat(object message, params object[] args)
    {
        UnityEngine.Debug.LogErrorFormat((string)message, args);
    }

    [System.Diagnostics.Conditional("UNITY_EDITOR")]
    public static void LogWarningFormat(object message, params object[] args)
    {
        UnityEngine.Debug.LogWarningFormat((string)message, args);
    }
}