...
public class InventoryManager : MonoBehaviour
{
    ...
    void Initialize()
    {
        ...
        receiveContents[4].Initialize(RewardType.EventTicket, playerDataBase.EventTicket);
        receiveContents[5].Initialize(RewardType.DefDestroyTicketPiece, playerDataBase.DefDestroyTicketPiece);
        receiveContents[6].Initialize(RewardType.DefDestroyTicket, playerDataBase.DefDestroyTicket);
